# Jessica Rumsey — Data Science Portfolio

This repository contains a selection of my graduate-level projects focused on data analysis, modeling, and decision support. These projects emphasize building and validating analytical models, working with real-world datasets, and communicating results clearly.

Each project includes its own README with technical details, methodology, and results. Below is just a brief overview.
...
- R
- Network & Regression Analysis (Predictive Modeling)
